...
(function() { this.JST || (this.JST = {}); this.JST["templates/search_result"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="search-result-container">\n  <a id="search-result-link" href="',  url ,'" target="_blank">',  title ,'</a>\n\n  <p id="search-result-description">',  description ,'</p>\n\n  <a id="search-result-tweet-to" href="https://twitter.com/share?url=', url,'&text=Check this out! ', handle,'" data-url="', url,'" class="twitter-share-button" onClick=\'showPopup(this.href);return(false);\'><img src="http://i.imgur.com/mOKt12S.png" height="25px"></a>\n\n  <br>to ', handle,'\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/tweet"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (links.length > 0){ ; __p.push('\n  <div class="tweet-container">\n\n    <img class="profile-pic" src="',  target_profile_image_url ,'" alt="">\n    <h4 class="target-name">',  target_name ,'</h3>\n    <h4 class="target-handle">@',  target_handle ,'</h3>\n\n    <div class="tweet-content">\n\n      <a href="',  links[0].url ,'" class="test" target="_blank">',  links[0].title ,'</a>\n      <h4>',  text ,'</h4>\n      <p>tweeted on ',  created_at ,'</p>\n\n      <div class="keyword-cloud">\n        ');  for (var i=0; i< text_keywords.length; i++) { ; __p.push('\n          <input class="keyword" type="submit" value="', text_keywords[i],'">\n        ');  } ; __p.push('\n\n        ');  for (var i=0; i< title_keywords.length; i++) { ; __p.push('\n          <input class="keyword" type="submit" value="', title_keywords[i],'">\n        ');  } ; __p.push('\n      </div>\n      <p><a id="search-result-tweet-to" href="https://twitter.com/share?in_reply_to=',  tweet_id,'&url=twitter.com" class="twitter-share-button" onClick=\'showPopup(this.href);return(false);\'><img src="http://i.imgur.com/cDWLWZz.png" height="25px"></a></p>\n    </div>\n  </div>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/twitter_user"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img class="profile-circles" src="',  profile_image ,'"/>\n\n<ul class="twitter-user-info">\n  <li id="twitter-user-name">',  name ,'</li>\n  <li id="twitter-user-handle"><a href="http://twitter.com/',  handle ,'" target="_blank">@',  handle ,'</a></li>\n  <!-- <li id="twitter-user-handle">',  user_type ,'</li> -->\n</ul>\n  <!-- <li id="twitter-user-description">(');  description ; __p.push(')</li> -->\n');}return __p.join('');};
}).call(this);
...
var TweetsView = Backbone.View.extend({
  ...
  addAll: function() {
    $("#one-degree-button-container").css("display", "block")
